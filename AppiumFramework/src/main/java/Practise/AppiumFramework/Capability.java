    ...
    public AppiumDriverLocalService startserver()
    {
        ...
        //service = AppiumDriverLocalService.buildDefaultService();
            service = AppiumDriverLocalService.buildService(new AppiumServiceBuilder()
                    ...
                    .withAppiumJS(new File("C:\\Users\\AnandB\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js"))
...
public static void startEmulator() throws IOException, InterruptedException {
        ...
        Runtime.getRuntime().exec(System.getProperty("user.dir")+"\\src\\main\\java\\Practise\\AppiumFramework\\Emulator.bat");
	...
	public static AndroidDriver<AndroidElement> capability(String appPackage,String appActivity,String deviceName,String chromedriverExecutable) throws IOException, InterruptedException {
		...
		chromedriverExecutable=pro.getProperty("chromedriverExecutable");
		 ...
		 //cap.setCapability(AndroidMobileCapabilityType.CHROMEDRIVER_EXECUTABLE,"C:\\Users\\AnandB\\Desktop\\Training\\chromedriver.exe");
